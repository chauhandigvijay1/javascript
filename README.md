...
- **Screenshot:**  
  ![Expense Tracker](./Expense-Tracker/expense-tracker.png)
...
- **Screenshot:**  
  ![Movie Finder](./Movie-Finder/movie-finder.png)
...
- **Screenshot:**  
  ![Static Quiz](./Quiz-App/static-version/static-quiz-app.png)
...
- **Screenshot:**  
  ![API Quiz](./Quiz-App/api-version/api-quiz-app.png)
